...
import projectstoragelibrarymanagement from '@/pages/intelligentMaintenanceManagementSystem/projectstoragelibrarymanagement/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('intelligentMaintenanceManagementSystem/_PROJECTSTORAGELIBARYMANAGEMENT', projectstoragelibrarymanagement);
  },
  destroyed ()
  {
    this.$store.unregisterModule('intelligentMaintenanceManagementSystem/_PROJECTSTORAGELIBARYMANAGEMENT');
  },
  methods: {

...
import cementroaddamage from '@/pages/intelligentMaintenanceManagementSystem/cementroaddamage/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('intelligentMaintenanceManagementSystem/_CEMENTROADDAMAGE', cementroaddamage);
  },
  destroyed ()
  {
    this.$store.unregisterModule('intelligentMaintenanceManagementSystem/_CEMENTROADDAMAGE');
  },
  methods: {

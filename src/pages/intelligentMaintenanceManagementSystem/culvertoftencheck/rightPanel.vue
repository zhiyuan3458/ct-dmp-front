...
import culvertOftenCheck from '@/pages/intelligentMaintenanceManagementSystem/culvertoftencheck/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('intelligentMaintenanceManagementSystem/_CULVERTOFTENCHECK', culvertOftenCheck);
  },
  destroyed ()
  {
    this.$store.unregisterModule('intelligentMaintenanceManagementSystem/_CULVERTOFTENCHECK');
  },
  methods: {

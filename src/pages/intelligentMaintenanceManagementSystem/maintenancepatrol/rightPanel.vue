...
import maintenancepatrol from '@/pages/intelligentMaintenanceManagementSystem/maintenancepatrol/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('intelligentMaintenanceManagementSystem/_MAINTENANCEPATROL', maintenancepatrol);
  },
  destroyed ()
  {
    this.$store.unregisterModule('intelligentMaintenanceManagementSystem/_MAINTENANCEPATROL');
  },
  methods: {

...
export default {
  ...
  methods: {
    ...
    submitForm ()
    {
      ...
      this.$store.dispatch('intelligentMaintenanceManagementSystem/_BRIDGEOFTENCHECK/showList', formCondition);
    },
    /**
     * 初始化select树数据
     * @author   chenguang
    ...
    initSelectTree ()
    {
      this.$store.dispatch('intelligentMaintenanceManagementSystem/_BRIDGEOFTENCHECK/getTree').then(data =>
      {

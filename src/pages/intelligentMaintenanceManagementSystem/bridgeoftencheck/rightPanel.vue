...
import bridgeoftencheck from '@/pages/intelligentMaintenanceManagementSystem/bridgeoftencheck/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('intelligentMaintenanceManagementSystem/_BRIDGEOFTENCHECK', bridgeoftencheck);
  },
  destroyed ()
  {
    this.$store.unregisterModule('intelligentMaintenanceManagementSystem/_BRIDGEOFTENCHECK');
  },
  methods: {

...
import roadevaluationdetail from '@/pages/intelligentMaintenanceManagementSystem/roadevaluationdetail/store/index';
...
export default {
  ...
  created ()
  {
    ...
    this.$store.registerModule('intelligentMaintenanceManagementSystem/_ROADEVALUATIONDETAIL', roadevaluationdetail);
  },
  destroyed ()
  {
    // 动态销毁
    this.$store.unregisterModule('intelligentMaintenanceManagementSystem/_ROADEVALUATIONDETAIL');
  },
  methods: {

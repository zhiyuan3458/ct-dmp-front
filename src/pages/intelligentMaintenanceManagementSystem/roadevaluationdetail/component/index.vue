  ...
  <div class="form-bar-content-wrapper">
    <el-form label-width="70px">
      ...
      <el-form-item label="车道">
        <el-select v-model="lane" placeholder="请选择">
          <el-option
      ...
      <el-form-item label="方向">
        <el-select v-model="detectionDirection" placeholder="请选择">
          <el-option
  ...
  methods: {
    ...
    submitForm ()
    {
      ...
      let obj = {
        ...
        lane: this.lane,
        detectionDirection: this.detectionDirection,
        startStake: this.startStake,
        endStake: this.endStake
      };
      this.$store.dispatch('intelligentMaintenanceManagementSystem/_ROADEVALUATIONDETAIL/showList', obj);
    }
  },
  created ()
  {
    this.$store.dispatch('intelligentMaintenanceManagementSystem/_ROADEVALUATIONDETAIL/getTree').then(data =>
    {

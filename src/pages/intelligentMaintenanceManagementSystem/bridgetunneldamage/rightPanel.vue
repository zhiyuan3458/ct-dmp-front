...
import bridgetunneldamage from '@/pages/intelligentMaintenanceManagementSystem/bridgetunneldamage/store/index';
...
export default {
  ...
  created ()
  {
    ...
    this.$store.registerModule('intelligentMaintenanceManagementSystem/_BRIDGETUNNELDAMAGE', bridgetunneldamage);
  },
  destroyed ()
  {
    // 动态销毁
    this.$store.unregisterModule('intelligentMaintenanceManagementSystem/_BRIDGETUNNELDAMAGE');
  },
  methods: {

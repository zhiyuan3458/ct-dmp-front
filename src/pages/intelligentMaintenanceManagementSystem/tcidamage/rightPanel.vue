...
import tcidamage from '@/pages/intelligentMaintenanceManagementSystem/tcidamage/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('intelligentMaintenanceManagementSystem/_TCIDAMAGE', tcidamage);
  },
  destroyed ()
  {
    this.$store.unregisterModule('intelligentMaintenanceManagementSystem/_TCIDAMAGE');
  },
  methods: {

...
import culvertRegularCheck from '@/pages/intelligentMaintenanceManagementSystem/culvertregularcheck/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('intelligentMaintenanceManagementSystem/_CULVERTREGULARCHECK', culvertRegularCheck);
  },
  destroyed ()
  {
    this.$store.unregisterModule('intelligentMaintenanceManagementSystem/_CULVERTREGULARCHECK');
  },
  methods: {

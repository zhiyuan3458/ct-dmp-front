...
import bitumenroaddamage from '@/pages/intelligentMaintenanceManagementSystem/bitumenroaddamage/store/index';
...
export default {
  ...
  created ()
  {
    ...
    this.$store.registerModule('intelligentMaintenanceManagementSystem/_BITUMENROADDAMAGE', bitumenroaddamage);
  },
  destroyed ()
  {
    // 动态销毁
    this.$store.unregisterModule('intelligentMaintenanceManagementSystem/_BITUMENROADDAMAGE');
  },
  methods: {

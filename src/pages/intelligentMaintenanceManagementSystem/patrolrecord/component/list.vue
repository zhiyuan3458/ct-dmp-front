...
export default {
  ...
  methods: {
    ...
    addFn ()
    {
      ...
      this.$store.dispatch('intelligentMaintenanceManagementSystem/_PATROLRECORD/add', {belongDeptId: this.deptIds});
    },
    /**
       * @Description: 查看
       * @author durenniu
    ...
    showFn (row)
    {
      this.$store.dispatch('intelligentMaintenanceManagementSystem/_PATROLRECORD/show', {id: row.id, deptId: this.deptIds});
    },
    /**
       * @Description: 编辑
       * @author durenniu
    ...
    editFn (row)
    {
      this.$store.dispatch('intelligentMaintenanceManagementSystem/_PATROLRECORD/edit', {id: row.id, deptId: this.deptIds});
    },
    /**
       * @Description: 删除
       * @author durenniu
    ...
    removeFn ()
    {
      if (this.multipleSelection !== undefined && this.multipleSelection.length > 0)
      {
        ...
        {
          this.$store.dispatch('intelligentMaintenanceManagementSystem/_PATROLRECORD/remove', {id: maintenancepatrolId}).then(() =>
          {
            this.$message({
              type: 'success',
              message: '删除成功!'
    ...
    getTableData ()
    {
      ...
      this.$store.dispatch('intelligentMaintenanceManagementSystem/_PATROLRECORD/listJson', {

...
export default {
  ...
  methods: {
    ...
    submitForm ()
    {
      ...
      this.$store.dispatch('intelligentMaintenanceManagementSystem/_PATROLRECORD/showList', formCondition);
    },
    /**
       * 初始化select树数据
       * @author   chenguang
    ...
    initSelectTree ()
    {
      this.$store.dispatch('intelligentMaintenanceManagementSystem/_PATROLRECORD/getTree').then(data =>
      {

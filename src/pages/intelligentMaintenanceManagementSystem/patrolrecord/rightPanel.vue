...
import patrolrecord from '@/pages/intelligentMaintenanceManagementSystem/patrolrecord/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('intelligentMaintenanceManagementSystem/_PATROLRECORD', patrolrecord);
  },
  destroyed ()
  {
    this.$store.unregisterModule('intelligentMaintenanceManagementSystem/_PATROLRECORD');
  },
  methods: {

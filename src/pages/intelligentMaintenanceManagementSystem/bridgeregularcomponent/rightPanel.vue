...
import bridgeregularcomponent from '@/pages/intelligentMaintenanceManagementSystem/bridgeregularcomponent/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('intelligentMaintenanceManagementSystem/_BRIDGEREGULARCOMPONENT', bridgeregularcomponent);
  },
  destroyed ()
  {
    this.$store.unregisterModule('intelligentMaintenanceManagementSystem/_BRIDGEREGULARCOMPONENT');
  },
  methods: {

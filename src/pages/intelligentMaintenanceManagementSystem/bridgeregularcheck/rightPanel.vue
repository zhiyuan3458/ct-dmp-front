...
import bridgeregularcheck from '@/pages/intelligentMaintenanceManagementSystem/bridgeregularcheck/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('intelligentMaintenanceManagementSystem/_BRIDGEREGULARCHECK', bridgeregularcheck);
  },
  destroyed ()
  {
    this.$store.unregisterModule('intelligentMaintenanceManagementSystem/_BRIDGEREGULARCHECK');
  },
  methods: {

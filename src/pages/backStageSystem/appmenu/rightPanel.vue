...
import appmenu from '@/pages/backStageSystem/appmenu/store/index';
export default {
  components: {
    treeRightPanel,
    index,
  ...
  created ()
  {
    this.$store.registerModule('backStageSystem/_APPMENU', appmenu);
  },
  destroyed ()
  {
    this.$store.unregisterModule('backStageSystem/_APPMENU');
  },
  methods: {

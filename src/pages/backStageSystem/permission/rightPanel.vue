...
import permission from '@/pages/backStageSystem/permission/store/index';
export default {
  components: {
    treeRightPanel,
    index,
  ...
  created ()
  {
    this.$store.registerModule('backStageSystem/_PERMISSION', permission);
  },
  destroyed ()
  {
    this.$store.unregisterModule('backStageSystem/_PERMISSION');
  },
  methods: {

...
import user from '@/pages/backStageSystem/user/store/index';
export default {
  components: {
    treeRightPanel,
    index,
  ...
  created ()
  {
    this.$store.registerModule('backStageSystem/_USER', user);
  },
  destroyed ()
  {
    this.$store.unregisterModule('backStageSystem/_USER');
  },
  methods: {

...
import processInstance from '@/pages/backStageSystem/activiti/processInstance/store/index';
export default {
  components: {
    treeRightPanel,
    index,
  ...
  created ()
  {
    this.$store.registerModule('backStageSystem/_PROCESSINSTANCE', processInstance);
  },
  destroyed ()
  {
    this.$store.unregisterModule('backStageSystem/_PROCESSINSTANCE');
  },
  methods: {

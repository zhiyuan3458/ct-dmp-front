...
import processTask from '@/pages/backStageSystem/activiti/processTask/store/index';
export default {
  components: {
    treeRightPanel,
    index,
  ...
  created ()
  {
    this.$store.registerModule('backStageSystem/_PROCESSTASK', processTask);
  },
  destroyed ()
  {
    this.$store.unregisterModule('backStageSystem/_PROCESSTASK');
  },
  methods: {

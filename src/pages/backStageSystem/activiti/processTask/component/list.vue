...
export default {
  ...
  methods: {
    addFn ()
    {
      this.$store.dispatch('backStageSystem/_PROCESSTASK/add', '');
    },
    showFn (row)
    {
      this.$store.dispatch('backStageSystem/_PROCESSTASK/show', {taskId: row.taskId});
    },
    /**
     * 转办
     * @author   yekuncai
    ...
    transferFn (row)
    {
      this.$store.dispatch('backStageSystem/_PROCESSTASK/transfer', {taskId: row.taskId});
    },
    /**
     * 取回
     * @author   yekuncai
    ...
    retrieveFn (row)
    {
      this.$store.dispatch('backStageSystem/_PROCESSTASK/retrieve', {taskId: row.taskId}).then(data =>
      {
    ...
    getTableData ()
    {
      ...
      this.$store.dispatch('backStageSystem/_PROCESSTASK/listJson', obj);
  ...
  computed: {
    ...mapGetters('backStageSystem/_PROCESSTASK', [
      'sideBar',
      'tableList',
      'tableBtns',
      'navigateMenus',

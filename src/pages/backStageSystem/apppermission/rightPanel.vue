...
import apppermission from '@/pages/backStageSystem/apppermission/store/index';
export default {
  components: {
    treeRightPanel,
    index,
  ...
  created ()
  {
    this.$store.registerModule('backStageSystem/_APPPERMISSION', apppermission);
  },
  destroyed ()
  {
    this.$store.unregisterModule('backStageSystem/_APPPERMISSION');
  },
  methods: {

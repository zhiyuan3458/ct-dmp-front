...
import weatherforecast from '@/pages/backStageSystem/weatherforecast/store/index';
export default {
  components: {
    treeRightPanel,
    index,
  ...
  created ()
  {
    this.$store.registerModule('backStageSystem/_WEATHERFORECAST', weatherforecast);
  },
  destroyed ()
  {
    this.$store.unregisterModule('backStageSystem/_WEATHERFORECAST');
  },
  methods: {

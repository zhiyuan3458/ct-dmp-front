...
import dictionary from '@/pages/backStageSystem/dictionary/store/index';
export default {
  components: {
    treeRightPanel,
    index,
  ...
  created ()
  {
    this.$store.registerModule('backStageSystem/_DICTIONARY', dictionary);
  },
  destroyed ()
  {
    this.$store.unregisterModule('backStageSystem/_DICTIONARY');
  },
  methods: {

...
export default {
  ...
  methods: {
    ...
    initTree ()
    {
      this.$store.dispatch('backStageSystem/_ICON/getTree').then(ztreeList =>
      {
        this.metaData.treeTool = new TreeTool('subLeftTree', ztreeList);
    ...
    {
      this.$store.dispatch('backStageSystem/_ICON/showList', treeNode.id);
    }
  },
  /**
   * 初始化树

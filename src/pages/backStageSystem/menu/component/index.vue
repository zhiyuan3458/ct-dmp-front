...
export default {
  ...
  methods: {
    ...
    initTree ()
    {
      this.$store.dispatch('backStageSystem/_MENU/getTree').then(data =>
      {
        let level = 1;
        ...
        this.metaData.treeTool.init('/api/backstage/sys/bs/menu/dragDrop', this.beforeDrop);
    ...
    {
      this.$store.dispatch('backStageSystem/_MENU/edit', {id: treeNode.id});
    },
    ...
    addFn (event)
    {
      ...
      this.$store.dispatch('backStageSystem/_MENU/add', {type: 0, parentId: treeNode.id});
    ...
    removeFn (event)
    {
      ...
      {
        this.$store.dispatch('backStageSystem/_MENU/remove', {
          type: treeNode.type,
          id: treeNode.id
        }).then(data =>
        {

...
import dept from '@/pages/backStageSystem/dept/store/index';
export default {
  components: {
    treeRightPanel,
    index,
  ...
  created ()
  {
    this.$store.registerModule('backStageSystem/_DEPT', dept);
  },
  destroyed ()
  {
    this.$store.unregisterModule('backStageSystem/_DEPT');
  },
  methods: {

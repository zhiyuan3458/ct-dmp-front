...
export default {
  ...
  methods: {
    ...
    initTree ()
    {
      this.$store.dispatch('backStageSystem/_DEPT/getTree').then(data =>
      {
        let level = 1;
        ...
        this.metaData.treeTool.init('/api/backstage/sys/bs/dept/dragDrop', this.beforeDrop);
    ...
    {
      this.$store.dispatch('backStageSystem/_DEPT/edit', {id: treeNode.id});
    },
    ...
    addFn (event)
    {
      ...
      this.$store.dispatch('backStageSystem/_DEPT/add', {parentId: treeNode.id});
    ...
    removeFn (event)
    {
      ...
      {
        this.$store.dispatch('backStageSystem/_DEPT/remove', {
          type: treeNode.type,
          id: treeNode.id
        }).then(data =>
        {

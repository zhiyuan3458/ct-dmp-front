...
import facilitymanage from '@/pages/backStageSystem/facilitymanage/store/index';
export default {
  components: {
    treeRightPanel,
    index,
  ...
  created ()
  {
    this.$store.registerModule('backStageSystem/_FACILITYMANAGE', facilitymanage);
  },
  destroyed ()
  {
    this.$store.unregisterModule('backStageSystem/_FACILITYMANAGE');
  },
  methods: {

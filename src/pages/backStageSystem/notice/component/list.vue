...
export default {
  ...
  methods: {
    addFn ()
    {
      this.$store.dispatch('backStageSystem/_NOTICE/add', { category: this.category });
    },
    showFn (row)
    {
      this.$store.dispatch('backStageSystem/_NOTICE/show', { id: row.id });
    },
    editFn (row)
    {
      this.$store.dispatch('backStageSystem/_NOTICE/edit', { id: row.id });
    },
    removeFn ()
    {
      let id = '';
      if (this.multipleSelection !== undefined)
      {
        ...
        let obj = { id: id };
        this.$store.dispatch('backStageSystem/_NOTICE/remove', obj);
      }
      else
      {
        this.$message('请选择!');
    ...
    getTableData ()
    {
      this.$store.dispatch('backStageSystem/_NOTICE/listJson', {

...
import notice from '@/pages/backStageSystem/notice/store/index';
export default {
  components: {
    treeRightPanel,
    index,
  ...
  created ()
  {
    this.$store.registerModule('backStageSystem/_NOTICE', notice);
  },
  destroyed ()
  {
    this.$store.unregisterModule('backStageSystem/_NOTICE');
  },
  methods: {

...
export default {
  ...
  methods: {
    ...
    {
      let level = 3;
      this.$store.dispatch('backStageSystem/_ORGANRELATION/getTree').then(data =>
      {
    ...
    {
      this.$store.dispatch('backStageSystem/_ORGANRELATION/getOrganrelationTree', {deptId: treeNode.id});
    }
  },
  computed: {

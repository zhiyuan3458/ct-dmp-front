...
import role from '@/pages/backStageSystem/role/store/index';
export default {
  components: {
    treeRightPanel,
    index,
  ...
  created ()
  {
    this.$store.registerModule('backStageSystem/_ROLE', role);
  },
  destroyed ()
  {
    this.$store.unregisterModule('backStageSystem/_ROLE');
  },
  methods: {

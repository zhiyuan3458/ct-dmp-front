...
import safetyFacilities from '@/pages/roadNetworkAssetManagementSystem/safetyfacilities/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('roadNetworkAssetManagementSystem/_SAFETYFACILITIES', safetyFacilities);
  },
  destroyed ()
  {
    this.$store.unregisterModule('roadNetworkAssetManagementSystem/_SAFETYFACILITIES');
  },
  methods: {

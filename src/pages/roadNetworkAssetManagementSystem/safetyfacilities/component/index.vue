...
export default {
  ...
  methods: {
    ...
    initTree ()
    {
      this.$store.dispatch('roadNetworkAssetManagementSystem/_SAFETYFACILITIES/getTree').then(data =>
      {
    ...
    {
      this.$store.dispatch('roadNetworkAssetManagementSystem/_SAFETYFACILITIES/showList', treeNode.id);
    },
    // 点击侧导航栏的上部图标触发
    clickTopBtn (e)
    {

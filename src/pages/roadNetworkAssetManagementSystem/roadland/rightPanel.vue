...
import roadLand from '@/pages/roadNetworkAssetManagementSystem/roadland/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('roadNetworkAssetManagementSystem/_ROADLAND', roadLand);
  },
  destroyed ()
  {
    this.$store.unregisterModule('roadNetworkAssetManagementSystem/_ROADLAND');
  },
  methods: {

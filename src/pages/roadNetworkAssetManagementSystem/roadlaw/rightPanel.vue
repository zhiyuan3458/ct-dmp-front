...
import roadlaw from '@/pages/roadNetworkAssetManagementSystem/roadlaw/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('roadNetworkAssetManagementSystem/_ROADLAW', roadlaw);
  },
  destroyed ()
  {
    this.$store.unregisterModule('roadNetworkAssetManagementSystem/_ROADLAW');
  },
  methods: {

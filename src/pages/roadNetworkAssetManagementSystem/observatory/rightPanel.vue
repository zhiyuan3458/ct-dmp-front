...
import observatory from '@/pages/roadNetworkAssetManagementSystem/observatory/store/index';
export default {
  components: {
    treeRightPanel,
    index,
  ...
  created ()
  {
    this.$store.registerModule('roadNetworkAssetManagementSystem/_OBSERVATORY', observatory);
  },
  destroyed ()
  {
    this.$store.unregisterModule('roadNetworkAssetManagementSystem/_OBSERVATORY');
  },
  methods: {

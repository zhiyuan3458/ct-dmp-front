...
import tunnel from '@/pages/roadNetworkAssetManagementSystem/tunnel/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('roadNetworkAssetManagementSystem/_TUNNEL', tunnel);
  },
  destroyed ()
  {
    this.$store.unregisterModule('roadNetworkAssetManagementSystem/_TUNNEL');
  },
  methods: {

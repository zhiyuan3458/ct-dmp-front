...
const actions = {
  async getTree ({commit})
  {
    try
    {
      let {data} = await api.section.getTree();
  ...
  async listJson ({commit}, obj)
  {
    try
    {
      ...
      let {data} = await api.section.listJson(obj);
  ...
  async add ({commit}, obj)
  {
    try
    {
      let response = await api.section.add(obj);
  ...
  async edit ({commit}, obj)
  {
    try
    {
      let response = await api.section.edit(obj);
      response.data.data.listRepeatSection = response.data.data.listRepeatSection !== undefined ? JSON.stringify(response.data.data.listRepeatSection) : '';
      response.data.data.listExternalSection = response.data.data.listExternalSection !== undefined ? JSON.stringify(response.data.data.listExternalSection) : '';
      response.data.data.qrCodeUrl = `${response.config.url}?id=${response.data.data.entity.id}`;
  ...
  async show ({commit}, obj)
  {
    try
    {
      let response = await api.section.show(obj);
      response.data.data.listRepeatSection = response.data.data.listRepeatSection !== undefined ? JSON.stringify(response.data.data.listRepeatSection) : '';
      response.data.data.listExternalSection = response.data.data.listExternalSection !== undefined ? JSON.stringify(response.data.data.listExternalSection) : '';
      response.data.data.qrCodeUrl = `${response.config.url}?id=${response.data.data.entity.id}`;
  ...
  async save ({commit}, obj)
  {
    try
    {
      let {data} = await api.section.save(obj);
  ...
  async remove ({commit}, obj)
  {
    try
    {
      let {data} = await api.section.remove(obj);

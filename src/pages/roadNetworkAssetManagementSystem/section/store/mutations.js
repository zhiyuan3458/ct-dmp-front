...
const mutations = {
  ...
  [mutationType.ADD] (state, data)
  {
    ...
    state.listRepeatSection = '';
    state.listExternalSection = data.listExternalSection;
    state.navigateMenus = data.navigateMenus;
    state.operateBtns = data.operateBtns;
    state.readOnly = data.readOnly;
    state.mgZtreeSelect = data.mgZtreeSelect;
    state.mtZtreeSelect = data.mtZtreeSelect;
  ...
  [mutationType.EDIT] (state, data)
  {
    ...
    state.mgZtreeSelect = data.mgZtreeSelect;
    state.mtZtreeSelect = data.mtZtreeSelect;
    state.listRepeatSection = data.listRepeatSection;
    state.listExternalSection = data.listExternalSection;
    state.isAddEditShow = true;
    state.isListShow = false;

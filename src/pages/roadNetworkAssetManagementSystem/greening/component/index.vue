...
export default {
  ...
  methods: {
    ...
    initTree ()
    {
      this.$store.dispatch('roadNetworkAssetManagementSystem/_GREENING/getTree').then(data =>
      {
    ...
    {
      this.$store.dispatch('roadNetworkAssetManagementSystem/_GREENING/showList', treeNode.id);
    },
    // 点击侧导航栏的上部图标触发
    clickTopBtn (e)
    {

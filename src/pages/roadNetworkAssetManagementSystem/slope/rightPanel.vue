...
import slope from '@/pages/roadNetworkAssetManagementSystem/slope/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('roadNetworkAssetManagementSystem/_SLOPE', slope);
  },
  destroyed ()
  {
    this.$store.unregisterModule('roadNetworkAssetManagementSystem/_SLOPE');
  },
  methods: {

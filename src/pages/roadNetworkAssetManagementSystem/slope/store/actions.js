...
const actions = {
  async getTree ({commit})
  {
    try
    {
      let {data} = await api.slope.getTree();
  ...
  async listJson ({commit}, obj)
  {
    try
    {
      ...
      let {data} = await api.slope.listJson(obj);
  ...
  async add ({commit}, obj)
  {
    try
    {
      let {data} = await api.slope.add(obj);
  ...
  async edit ({commit}, obj)
  {
    try
    {
      let response = await api.slope.edit(obj);
  ...
  async show ({commit}, obj)
  {
    try
    {
      let response = await api.slope.show(obj);
      response.data.data.qrCodeUrl = `${response.config.url}?id=${response.data.data.entity.id}`;
  ...
  async save ({commit}, obj)
  {
    try
    {
      let {data} = await api.slope.save(obj);
  ...
  async remove ({commit}, obj)
  {
    try
    {
      let {data} = await api.slope.remove(obj);

...
import servicefacilities from '@/pages/roadNetworkAssetManagementSystem/servicefacilities/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('roadNetworkAssetManagementSystem/_SERVICEFACILITIES', servicefacilities);
  },
  destroyed ()
  {
    this.$store.unregisterModule('roadNetworkAssetManagementSystem/_SERVICEFACILITIES');
  },
  methods: {

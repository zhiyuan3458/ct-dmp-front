...
import bridge from '@/pages/roadNetworkAssetManagementSystem/bridge/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('roadNetworkAssetManagementSystem/_BRIDGE', bridge);
  },
  destroyed ()
  {
    this.$store.unregisterModule('roadNetworkAssetManagementSystem/_BRIDGE');
  },
  methods: {

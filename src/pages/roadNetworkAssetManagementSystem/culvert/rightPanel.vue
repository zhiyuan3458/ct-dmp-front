...
import culvert from '@/pages/roadNetworkAssetManagementSystem/culvert/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('roadNetworkAssetManagementSystem/_CULVERT', culvert);
  },
  destroyed ()
  {
    this.$store.unregisterModule('roadNetworkAssetManagementSystem/_CULVERT');
  },
  methods: {

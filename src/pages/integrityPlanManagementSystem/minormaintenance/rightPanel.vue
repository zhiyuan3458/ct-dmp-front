...
import minormaintenance from '@/pages/integrityPlanManagementSystem/minormaintenance/store/index';
...
export default {
  ...
  created ()
  {
    ...
    this.$store.registerModule('integrityPlanManagementSystem/_MINORMAINTENANCE', minormaintenance);
  },
  destroyed ()
  {
    // 动态销毁
    this.$store.unregisterModule('integrityPlanManagementSystem/_MINORMAINTENANCE');
  },
  methods: {

...
export default {
  ...
  methods: {
    submitForm ()
    {
      ...
      this.$store.dispatch('integrityPlanManagementSystem/_MINORMAINTENANCE/showList', extraCondition);
    }
  },
  created ()
  {
    this.$store.dispatch('integrityPlanManagementSystem/_MINORMAINTENANCE/getTree').then(data =>
    {

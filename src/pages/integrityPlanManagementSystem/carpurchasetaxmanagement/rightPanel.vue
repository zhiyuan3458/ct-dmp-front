...
import carpurchasetaxmanagement from '@/pages/integrityPlanManagementSystem/carpurchasetaxmanagement/store/index';
...
export default {
  ...
  created ()
  {
    ...
    this.$store.registerModule('integrityPlanManagementSystem/_CARPURCHASETAXMANAGEMENT', carpurchasetaxmanagement);
  },
  destroyed ()
  {
    // 动态销毁
    this.$store.unregisterModule('integrityPlanManagementSystem/_CARPURCHASETAXMANAGEMENT');
  },
  methods: {

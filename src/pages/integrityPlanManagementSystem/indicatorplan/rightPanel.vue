...
import indicatorplan from '@/pages/integrityPlanManagementSystem/indicatorplan/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('integrityPlanManagementSystem/_INDICATORPLAN', indicatorplan);
  },
  destroyed ()
  {
    this.$store.dispatch('setBusinessId', '');
    this.$store.unregisterModule('integrityPlanManagementSystem/_INDICATORPLAN');
  },
  methods: {

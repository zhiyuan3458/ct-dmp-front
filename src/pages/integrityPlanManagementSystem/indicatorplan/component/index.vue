...
export default {
  ...
  methods: {
    ...
    initTree ()
    {
      this.$store.dispatch('integrityPlanManagementSystem/_INDICATORPLAN/getTree').then(data =>
      {
    ...
    {
      this.$store.dispatch('integrityPlanManagementSystem/_INDICATORPLAN/showList', key);
    },
    getLeave ()
    {
      let obj = { id: this.businessId };
      this.$store.dispatch('integrityPlanManagementSystem/_INDICATORPLAN/edit', obj);
    }
  },
  computed: {

...
import maintenancelinegrading from '@/pages/integrityPlanManagementSystem/maintenancelinegrading/store/index';
...
export default {
  ...
  created ()
  {
    ...
    this.$store.registerModule('integrityPlanManagementSystem/_MAINTENANCELINEGRADING', maintenancelinegrading);
  },
  destroyed ()
  {
    // 动态销毁
    this.$store.unregisterModule('integrityPlanManagementSystem/_MAINTENANCELINEGRADING');
  },
  methods: {

<template>
  ...
  >
    <div slot="tree">
      <index @getLevel="getLevel" :rootId="rootId" :urlType="urlType"></index>
    </div>
...
import indicator from '@/pages/integrityPlanManagementSystem/indicator/store/index';
...
export default {
  ...
  created ()
  {
    this.$store.registerModule('integrityPlanManagementSystem/_INDICATOR', indicator);
  },
  destroyed ()
  {
    this.$store.unregisterModule('integrityPlanManagementSystem/_INDICATOR');
  },
  methods: {

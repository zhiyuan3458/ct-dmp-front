...
import roadmaintenanceprojectplan from '@/pages/integrityPlanManagementSystem/roadmaintenanceprojectplan/store/index';
...
export default {
  ...
  created ()
  {
    ...
    this.$store.registerModule('integrityPlanManagementSystem/_ROADMAINTENANCEPROJECTPLAN', roadmaintenanceprojectplan);
  },
  destroyed ()
  {
    // 动态销毁
    this.$store.unregisterModule('integrityPlanManagementSystem/_ROADMAINTENANCEPROJECTPLAN');
  },
  methods: {

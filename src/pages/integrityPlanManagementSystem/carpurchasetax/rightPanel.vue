...
import carpurchasetax from '@/pages/integrityPlanManagementSystem/carpurchasetax/store/index';
...
export default {
  ...
  created ()
  {
    ...
    this.$store.registerModule('integrityPlanManagementSystem/_CARPURCHASETAX', carpurchasetax);
  },
  destroyed ()
  {
    // 动态销毁
    this.$store.unregisterModule('integrityPlanManagementSystem/_CARPURCHASETAX');
  },
  methods: {
